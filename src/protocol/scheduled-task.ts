...
export const ScheduledTaskInputSchema = Type.Object(
...
export type ScheduledTaskMutationResponse = Readonly<{ task: ScheduledTask }>;
export type DeleteScheduledTaskResponse = Readonly<{ status: "deleted"; taskId: string }>;
