export const workbench = {
  ...
  composer: {
    ...
    applyDraft: "应用草稿",
    applyDraftDescription: "应用草稿将覆盖输入框中的当前内容。是否继续？",
    ...
    closeDraftEditing: "关闭草稿编辑并保留未保存修改",
    deleteDraft: "删除草稿：{{summary}}",
    draftCount: "草稿 {{count}}",
    draftHasChanges: "有未保存修改",
    draftList: "{{project}}的草稿",
    editingDraft: "编辑草稿",
    ...
    sandboxMode: "沙盒模式",
    saveAsDraft: "保存为草稿",
    saveDraftChanges: "保存草稿修改",
    saveDraftFailed: "无法保存草稿",
    sendSteer: "发送引导",
