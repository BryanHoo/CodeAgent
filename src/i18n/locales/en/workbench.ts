export const workbench = {
  ...
  composer: {
    ...
    applyDraftDescription: "Applying this draft will replace the current composer content. Continue?",
    ...
    closeDraftEditing: "Close draft editing and keep unsaved changes",
    deleteDraft: "Delete draft: {{summary}}",
    draftCount: "Drafts {{count}}",
    draftHasChanges: "Unsaved changes",
    draftList: "{{project}} drafts",
