...
export function legacyUpdateManifest(version, signature, repository) {
  ...
  return {
    ...
    platforms: {
      "darwin-x86_64": {
        ...
        url: `https://github.com/${repository}/releases/download/v${version}/CodeAgent_${version}_x64_legacy.app.tar.gz`,
      },
    },
  };
}
...
if (import.meta.main) {
  ...
  const manifest = legacyUpdateManifest(process.env.APP_VERSION, signature, process.env.GITHUB_REPOSITORY);
