...
function LoginPage() {
  return (
    <div className="grid h-full grid-rows-[56px_1fr] bg-canvas">
      <header className="flex items-center border-b border-border bg-surface px-5">
        <BrandLink />
      </header>
      <main className="grid min-h-0 place-items-center px-6" aria-labelledby="login-title">
        <section className="w-full max-w-sm text-center">
          ...
          <button
            className="mt-6 w-full border border-border bg-surface-muted px-4 py-2.5 text-sm font-medium text-muted-foreground disabled:cursor-not-allowed"
            disabled
            type="button"
          >
            等待 Runtime
