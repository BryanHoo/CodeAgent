export const workbench = {
  ...
  pending: {
    ...
    permissionsApproval: "Permission request",
    readPermission: "Read",
  ...
  hostFilePicker: {
    ...
    description: "Browse files and folders on the device running CodeAgent",
    directoryTitle: "Select project folder",
    emptyDirectory: "This folder has no subfolders",
    emptyFile: "This folder has no supported files",
    expand: "Expand {{name}}",
    fileTitle: "Select local file",
    filesystemRoot: "Select drive",
    goToPath: "Go to absolute path",
    hideHidden: "Hide hidden files",
    imageTitle: "Select local image",
    loadError: "Unable to read this path",
    loading: "Reading files",
    noDirectory: "No folder selected",
    noFile: "No file selected",
    parent: "Go to parent folder",
    pathPlaceholder: "Enter an absolute path",
  ...
  sidebar: {
    ...
    settings: "Settings",
    settingsLabel: "Settings, CodeAgent {{version}}{{update}}",
